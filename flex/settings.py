...
SECRET_KEY = 'django-insecure-k^hd=$($@c%@=__(d9wv@(#)@)+-#rws#ysv%d*r&92)=zgh*$'
...
EMAIL_HOST_USER = 'karthik07605kk@gmail.com'  # Your Outlook email
EMAIL_HOST_PASSWORD = 'zdef rdte nmss lhcb'  # Use App Password if 2FA is enabled
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER

SITE_URL = 'https://karthik076052.pythonanywhere.com'